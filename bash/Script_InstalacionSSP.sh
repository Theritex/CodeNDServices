...
# Este script puede se encontraod en su repositorio oficial: https://github.com/Nisamov/ssp
    # Solo es un ejemplo para el lector, pues permite el rapido aprendizaje gracias a la clara estructura y documentación del script, asi como usa diferentes funciones y variables no mostradas en el documento
